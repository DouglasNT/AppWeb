    ...
    <div style="display: flex; justify-content:center; align-items:center; height:50vh">
        ...
        @csrf
            <div class="col-md-6">
                ...
                <input type="text" name="veiculo" value="{{old('veiculo', $registrosFrota->veiculo)}}" class="form-control" id="inputVeiculo" placeholder="BMW">
                @error('veiculo')
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="motorista" value="{{old('motorista', $registrosFrota->motorista)}}" class="form-control" id="inputMotorista" placeholder="jose">
                @error('motorista')
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="placa" value="{{old('placa', $registrosFrota->placa)}}" class="form-control" id="inputPlaca" placeholder="sem-0000">
                @error('placa')
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="data" value="{{old('data', $registrosFrota->data)}}" class="form-control" id="inputData" placeholder="01/02/0304">
                @error('data')
